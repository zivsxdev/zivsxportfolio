...
const projects = [
  {
    ...
    tags: ["Next.js • TypeScript • Tailwind CSS • Node.js • Express.js • MongoDB • Gemini AI • Browserbase • JWT • REST API"],
    ...
    href: "https://github.com/zivsxtrading",
    year: "2025",
  ...
  },
  {
    ...
    description: "RESTful API platform with rate-limiting, auth middleware, and full documentation. Clean architecture with separation of concerns.",
    href: "https://github.com/zivsxtrading",
    year: "2025",
  ...
  },
  {
    ...
    description: "A reusable design system and component library with full accessibility compliance, dark mode, and comprehensive documentation.",
    href: "https://github.com/zivsxtrading",
    year: "2026",
